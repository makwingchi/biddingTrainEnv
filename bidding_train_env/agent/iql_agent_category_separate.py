...
class IqlAgent(BaseAgent):
    ...
    def action(self, tick_index, budget, remaining_budget, pv_values, history_pv_values, history_bid,
        ...
        normalize_dict_selection = {
            0: self.normalize_dict1,
            1: self.normalize_dict2,
            2: self.normalize_dict3,
            3: self.normalize_dict4,
            4: self.normalize_dict5,
        }

        curr_model = model_selection[int(self.category)]
        curr_normalize_dict = normalize_dict_selection[int(self.category)]
