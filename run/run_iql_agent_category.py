...
def train_iql_model():
    ...
    training_data6 = training_data[training_data["agentIndex"] % 6 == 5].reset_index(drop=True)
    ...
    if is_normalize:
        ...
        training_data6['reward'] = normalize_reward(training_data6)
    ...
    add_to_replay_buffer(replay_buffer6, training_data6, is_normalize)
    ...
    train_model_steps(model6, replay_buffer6)
    ...
    model6.save_net("saved_model/IQLtest6")
